...
do
    ...
    python train.py --solver jkonet-star --dataset potential_$potential\_internal_none_beta_0.0_interaction_none_dt_0.01_T_5_dim_2_N_2000_gmm_10_seed_0_split_0.5_split_trajectories_True --wandb
done